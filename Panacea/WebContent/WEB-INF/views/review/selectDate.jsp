...
String srchedDate = (String)request.getAttribute("srchMon");
String srchedMon1 = "";
String srchedMon2 = "";
String srchedMon3 = "";
String srchedMon4 = "";
if(srchedDate.equals("1")){
	srchedMon1 = "checked";
}else if(srchedDate.equals("3")){
	srchedMon2 = "checked";
}else if(srchedDate.equals("6")){
	srchedMon3 = "checked";
}
%>
   ...
   <div id="sub_menu">
       ...
       <section id="srch-container">
			<form action="<%=request.getContextPath()%>/review/selectReview" name = "srchFrm">
				...
				<input type="radio" name="srchType" id="title"  class = "srchType" value = "title"  />
				...
				<input type="radio" name="srchType" id="Date" class = "srchType" value = "Date" checked />
				<label for="Date" class = "srchType">월별</label>
				<br />
				<div id="srchKey" style = "display : none">
				<br />
				<input type="search" name="srchKeyword" id="srchKeyword" placeholder = "검색할 제목 입력"  />
				<br />
				</div>
				<div id="srchDate" >
				<br />
				<input type="radio" name="srchMon" value = "1" <%=srchedMon1 %>/>1 개월 <br />
				<input type="radio" name="srchMon" value = "3" <%=srchedMon2 %>/>3 개월 <br />
				<input type="radio" name="srchMon" value = "6" <%=srchedMon3 %>/>6 개월 <br />
 				</div>
				<br />
   ...
   <div id="container-reviewList">
	...
	<%if(loginAdmin != null && loginPatient == null && loginDoctor == null){ %>
  	...
  	<table id="tbl-review">
   		<%if(loginAdmin != null && loginPatient == null && loginDoctor == null){ %>
  		<tr>
  		<td><input type="button"  value = "삭제"  onclick = "fn_deleteByChk()"/></td>
  		</tr>
  		<% } %>
  		...
  		<%if(list != null && !list.isEmpty()) {%>
  			<% for (Review r : list){ %>
  				<tr>
  					<%if(loginAdmin != null && loginPatient == null && loginDoctor == null){ %>
  					<th><input type="checkbox" name="delChk" class="delChk" value = <%=r.getReviewNo() %> onclick = "fn_delChk();" /></th>
  					<%} %>
  					<td>
