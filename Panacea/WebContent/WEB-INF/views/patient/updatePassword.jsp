...
<%
	...
	System.out.println("userid@updatePassword="+userId); 
%>
<!DOCTYPE html>
<html>
<head>
...
<div id="updatePW-container">
		<form action="<%=request.getContextPath() %>/patient/updatePasswordEnd" method="post" onsubmit="return fn_passwordValidate();">
