 ...
 * Generated at: 2018-05-17 09:34:27 UTC
...
public final class reservation_005fstep2_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(!isLogin){ 
 ...
 if("patient".equals(loginType) && loginPatient !=null){
      ...
      out.write("\r\n");
      out.write("\t\t<div id=\"reservation-doctors\">\t\t\t\r\n");
      out.write("\t\t\t");
...
for(int i = 0; i < partDoctors.size(); i++){
      ...
      out.print(partDoctors.get(i).getDoctorProfile());
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<span id=\"doctor-name\">");
      out.print(partDoctors.get(i).getDoctorName() );
      out.write("</span>&nbsp;선생님\r\n");
      out.write("\t\t\t\t\t\t\t\t<p>");
      out.print(partDoctors.get(i).getDoctorIntoduce() );
      out.write("</p>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"reservation-btn\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"button\"  value=\"예약하기\" onclick=\"selectPartDoctor('");
      out.print(partDoctors.get(i).getPartId());
      out.write('\'');
      out.write(',');
      out.write('\'');
      out.print(partDoctors.get(i).getDoctorId());
      out.write("');\" />\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t");
if(i%3 == 2 || i == partDoctors.size()-1) {
      ...
      out.write("\r\n");
      out.write("<script>\r\n");
      out.write("function selectPartDoctor(partId,doctorId){\r\n");
      out.write("\tlocation.href=\"");
      out.print(request.getContextPath());
      out.write("/reservation/step3Reservation?partId=\"+partId+\"&doctorId=\"+doctorId;\r\n");
      out.write("}\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
      out.write("\r\n");
