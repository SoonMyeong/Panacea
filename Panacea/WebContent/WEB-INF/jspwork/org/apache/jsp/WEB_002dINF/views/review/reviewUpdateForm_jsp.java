 ...
 * Generated at: 2018-05-18 11:36:28 UTC
...
if(!isLogin){ 
 ...
 if("patient".equals(loginType) && loginPatient !=null){
      ...
      out.write("\t\t<h2>후기 수정</h2>\r\n");
      out.write("\t\t<form action=\"");
      out.print(request.getContextPath());
      out.write("/review/reviewUpdateEnd\" method=\"post\" >\r\n");
...
if(review.getGrade() == 1){ 
      ...
      out.write(">1 점</option>\r\n");
      out.write("\t\t\t\t\t\t<option value=\"2\" ");
if(review.getGrade() == 2){ 
      out.write("selected = \"selected\"");
} 
      out.write(">2 점</option>\r\n");
      out.write("\t\t\t\t\t\t<option value=\"3\" ");
if(review.getGrade() == 3){ 
      out.write("selected = \"selected\"");
} 
      out.write(">3 점</option>\r\n");
      out.write("\t\t\t\t\t\t<option value=\"4\" ");
if(review.getGrade() == 4){ 
      out.write("selected = \"selected\"");
} 
      out.write(">4 점</option>\r\n");
      out.write("\t\t\t\t\t\t<option value=\"5\" ");
if(review.getGrade() == 5){ 
      out.write("selected = \"selected\"");
} 
      out.write(">5 점</option>\r\n");
      out.write("\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t        </tr>\r\n");
      out.write("\t\t        <tr>\r\n");
      out.write("\t\t            <th>내 용</th>\r\n");
      out.write("\t\t            <td>\r\n");
      out.write("\t\t            \t<textarea name=\"content\" cols=\"50\" rows=\"5\">");
      ...
      out.write("\t\t        \t\t<input type=\"submit\" value=\"수 정 하 기\" onclick=\"return validate()\"/>\r\n");
      out.write("\t\t        \t</th>\r\n");
      out.write("\t\t        </tr>\r\n");
      out.write("\t\t\t</table>\r\n");
      out.write("\t\t</form>\r\n");
