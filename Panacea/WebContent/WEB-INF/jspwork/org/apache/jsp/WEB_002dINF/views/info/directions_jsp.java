 ...
 * Generated at: 2018-05-18 10:42:58 UTC
...
if(!isLogin){ 
 ...
 if("patient".equals(loginType) && loginPatient !=null){
      ...
      out.write("\t<img id=\"map\" src=\"");
      out.print(request.getContextPath() );
      out.write("/img/info/map.png\" alt=\"지도\">\r\n");
      out.write("\t<div id=\"description\">\r\n");
      out.write("\t\t<h3>서울광역시 강남구 역삼동</h3>\r\n");
      out.write("\t\t<h2>파나시아 병원</h2>\r\n");
      out.write("    \t<h4>예약번호 : 02-123-4567</h4>\r\n");
      out.write("    \t<br>\r\n");
      out.write("\t\t<h3>● \"버스\"로 오시는 경우</h3>\r\n");
      out.write("\t\t&nbsp;&nbsp;&nbsp;역삼역 방향 : 147번, 463번, 4211번, 6000번, 6020번\r\n");
      out.write("\t\t<h3>● \"지하철\"로 오시는 경우</h3>\r\n");
      out.write("\t\t&nbsp;&nbsp;&nbsp;지하철 2호선 역삼역 1번 출구 도보 5분\r\n");
      out.write("\t\t<br><br>\r\n");
      out.write("\t</div>\r\n");
      out.write("</div>\r\n");
      out.write("\r\n");
