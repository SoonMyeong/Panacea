 ...
 * Generated at: 2018-05-17 10:01:21 UTC
...
public final class doctor_005fview_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(!isLogin){ 
 ...
 if("patient".equals(loginType) && loginPatient !=null){
      ...
      out.write("\t\r\n");
      out.write("\t<h3 id=\"part-title\">\"");
      out.print(searchDoctorName );
      out.write("\"선생님 검색결과</h3>\r\n");
      out.write("\t<hr id=\"part-partition\">\r\n");
      out.write("\t\t\r\n");
      out.write("\t");
if(searchDoctors != null && !searchDoctors.isEmpty()) { 
      out.write("\r\n");
      out.write("\t<table id=\"search-doctors\">\r\n");
      out.write("\t\t");
for(int i = 0; i < searchDoctors.size(); i++){
      ...
      out.write("\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t<div class=\"part-doctor-introduce\">\r\n");
      out.write("\t\t\t\t\t\t<img id=\"profile\" alt=\"프로필\" src=\"");
      out.print(request.getContextPath());
      out.write("/upload/doctor/");
      out.print(searchDoctors.get(i).getDoctorProfile());
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t<span id=\"part-name\">");
      out.print(searchDoctors.get(i).getPartName() );
      out.write("</span><br>\r\n");
      out.write("\t\t\t\t\t\t<span id=\"doctor-name\">");
      out.print(searchDoctors.get(i).getDoctorName() );
      out.write("</span>&nbsp;선생님\r\n");
      out.write("\t\t\t\t\t\t<p>");
      out.print(searchDoctors.get(i).getDoctorIntoduce() );
      out.write("</p>\r\n");
      out.write("\t\t\t\t\t\t");
if(loginType != null && loginType.equals("patient")){ 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"button\" id=\"reservation-btn\" value=\"예약하기\" onclick=\"location.href='");
      out.print(request.getContextPath() );
      out.write("/reservation/step3Reservation?partId=");
      out.print(searchDoctors.get(i).getPartId() );
      out.write("&doctorId=");
      out.print(searchDoctors.get(i).getDoctorId() );
      out.write("';\" />\r\n");
      out.write("\t\t\t\t\t\t");
} 
      out.write("\r\n");
