 ...
 * Generated at: 2018-05-18 11:36:45 UTC
...
import java.util.*;
import com.panacea.review.model.exception.*;
import com.panacea.patient.model.vo.*;
import com.panacea.doctor.model.vo.*;
import com.panacea.admin.model.vo.*;

public final class selectTitle_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_packages.add("com.panacea.review.model.exception");
...
System.out.println("list.isEmpty@reviewList.jsp = "+ list.isEmpty());
      ...
      out.write("\t\t\t$(\"#srchKey\").show();\r\n");
      out.write("\t\t\t$(\"#srchKey\").children().show();\r\n");
 ...
 if(loginPatient == null && loginAdmin == null && loginDoctor == null){ 
      ...
      out.write("\t\t\t\t<input type=\"radio\" name=\"srchType\" id=\"title\"  class = \"srchType\" value = \"title\"  checked />\r\n");
...
if(loginAdmin != null && loginPatient == null && loginDoctor == null){ 
      out.write("\r\n");
      out.write("  \t\t\t\t\t<th><input type=\"checkbox\" name=\"delChk\" id=\"delChk\" value = ");
