 ...
 * Generated at: 2018-05-17 09:00:40 UTC
...
if(!isLogin){ 
 ...
 if("patient".equals(loginType) && loginPatient !=null){
      ...
      out.print(request.getContextPath() );
      out.write("/common/loginEnd\" method=\"post\">\r\n");
      out.write("\t<table id=\"login-table\">\r\n");
      out.write("\t\t<tr>\r\n");
      out.write("\t\t\t<td colspan=\"2\">\r\n");
      out.write("\t\t\t\t<input type=\"radio\" name=\"loginType\" id=\"patient\" value=\"patient\" ");
      out.print(("patient".equals(savedUserType)||!saveType)?"checked":"" );
      out.write(" >\r\n");
      out.write("\t\t\t\t<label for=\"patient\">환자</label>\r\n");
      out.write("\t\t\t\t<input type=\"radio\" name=\"loginType\" id=\"doctor\" value=\"doctor\" ");
      out.print("doctor".equals(savedUserType)?"checked":"" );
      out.write(" >\r\n");
      out.write("\t\t\t\t<label for=\"doctor\">의사</label>\r\n");
      out.write("\t\t\t\t<input type=\"radio\" name=\"loginType\" id=\"admin\" value=\"admin\" ");
      out.print("admin".equals(savedUserType)?"checked":"" );
      out.write(" >\r\n");
      ...
      out.write("\t\t<tr>\r\n");
      out.write("\t\t\t<td colspan=\"2\">\r\n");
      out.write("\t\t\t\t<input type=\"submit\" value=\"로그인\" id=\"loginBtn\" onclick=\"return loginValidate()\">\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t<tr>\r\n");
      out.write("\t\t\t<td colspan=\"2\">\r\n");
      out.write("\t\t\t\t<button type=\"button\" id=\"findId\">아이디찾기</button>\r\n");
      out.write("\t\t\t\t<button type=\"button\" id=\"findPw\">비밀번호찾기</button>\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t</table>\r\n");
      out.write("\t</form>\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\t\tif($(\"#userPw\").val().trim().length == 0){\r\n");
      ...
      out.write("\t\tvar url = \"");
      out.print(request.getContextPath());
      out.write("/common/findId\";\r\n");
      out.write("\t\tvar title = \"아이디 찾기\";\r\n");
      out.write("\t\tvar status = \"left=400px, top=200px, width=500px, height=350px\";\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tvar popup = window.open(url, title, status);\r\n");
      out.write("\t});\r\n");
      out.write("\t\r\n");
      out.write("\t$(\"#findPw\").on(\"click\",function(){\r\n");
      out.write("\t\tvar url = \"");
      out.print(request.getContextPath());
      out.write("/common/findPw\";\r\n");
      out.write("\t\tvar title = \"비밀번호 찾기\";\r\n");
      out.write("\t\tvar status = \"left=400px, top=200px, width=500px, height=350px\";\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tvar popup = window.open(url, title, status);\r\n");
      out.write("\t});\r\n");
